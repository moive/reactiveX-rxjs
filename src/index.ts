...
import obs1$ from "./observables/observable1";
import obs2$ from "./observables/observables2";
import observableOf from "./observables/observableOf";
import observableFromEvent from "./observables/observableFromEvent";
import observableRange from "./observables/observableRange";
...
// observableOf(); //function observables of
